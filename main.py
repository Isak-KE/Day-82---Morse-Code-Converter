...
def run(string):
    ...
    if regex.search(string) is None:
        print("Encyrption Result: ")
        print(encrypt(string.upper()))
...
def main():
    print("Morse Code Converter Ver 1,0")
    print("*******************************************")
    phrase = input("Please enter a phase to covert: ")

    # Check for the format and convert
    run(phrase)
